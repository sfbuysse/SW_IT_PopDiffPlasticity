...
# stomatal density - FOV under 40x magnification is 29.87μm in width, 22.87 μm in height. Area is 683.17 μm2 if square (or .000683 mm2). 536.2546 if oval
...
# if density was 100 stomata per mm2, go backward to what our counts would be
#100 * 0.000683 - so less than one stomata in our viewing range which does not make sense
# test in mm2
# CleanData_2022$Stomata_avg / 0.000683
```
