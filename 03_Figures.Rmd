...
```{r, echo = FALSE}
totbio <- ggplot(data = Means_2022[["TotBio_means_22"]], aes(x = Treatment, y = Mean)) +
  geom_point(aes(col=Population, shape = Population), size = 3, position = position_dodge(width = 0.3), show.legend = TRUE) +
  geom_errorbar(aes(ymin=LL_95, ymax = UL_95, col = Population), width = 0.3, size = 0.8, position = position_dodge(width = 0.3), show.legend = TRUE)+
  geom_line(aes(group = Population, col = Population), size = 1, linetype = "dotted", position = position_dodge(width = 0.3))+ 
...
figs in vector format; need to have no 'ragg' package to actually be saved with times new roman font for rasters. Need to specify within save line to embed in svg.
```{r}

# trait figs
ggsave(fig1, filename = "figures/fig1_times.svg", width = 6, height = 8, units = "in", dpi = 1000, device = "svg", system_fonts = list(Times = "Times New Roman"))
ggsave(fig2, filename = "figures/fig2_times.svg", width = 6, height = 8, units = "in", dpi = 1000, system_fonts = list(Times = "Times New Roman"))

# fitness fig
ggsave(fitness_fig, filename = "figures/fig3_times.svg", width = 9, height = 4, units = "in", dpi = 1000, system_fonts = list(Times = "Times New Roman"))

# legend_fig
ggsave(legend_fig, filename = "figures/legend_fig_times.svg", width = 6, height = 0.5, units = "in", dpi = 1000, system_fonts = list(Times = "Times New Roman"))

#figs1
ggsave(figs1, filename = "figures/figs1_times.svg", width = 9, height = 8, units = "in", dpi = 600, system_fonts = list(Times = "Times New Roman"))

#figs2
ggsave(figs3, filename = "figures/figs3_times.svg", width = 9, height = 8, units = "in", dpi = 600, system_fonts = list(Times = "Times New Roman"))
```
