...
This code runs all linear models for the 2021 and 2022 experiments. This code all worked prior to revisions made in March 2026 and now does not all work. the Analysis.Rmd file has all the code relevant to the final versin of the manuscipt.
...
# check outliers. can't trust colored figures in this output
