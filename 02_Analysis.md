...
Dat_2021_TwoTrt$Geno_ID <- as.factor(paste0(Dat_2021_TwoTrt$Population, Dat_2021_TwoTrt$Line))
get_geno_table <- function (trait, data = Dat_2021_TwoTrt){
...
get_geno_table_bt <- function(trait, data = Dat_2021_TwoTrt){
...
geno_eTof <- as.data.frame(get_geno_table(Dat_2021_TwoTrt$EmergeToFlwr))
...
geno_sla_21 <- as.data.frame(get_geno_table_bt(Dat_2021_TwoTrt$l10_SLA))
...
geno_rwc_21 <- as.data.frame(get_geno_table(Dat_2021_TwoTrt$RWC))
...
geno_fruits <- as.data.frame(get_geno_table(Dat_2021_TwoTrt$FruitCount_BL))
...
geno_seeds <- as.data.frame(get_geno_table_bt(Dat_2021_TwoTrt$l10_AvgSeedNum))
...
geno_fitness <- as.data.frame(get_geno_table(Dat_2021_TwoTrt$fitness))
...
get_geno_table22 <- function (trait, data = Dat_2022){
  tab2 <- emmeans(lm(trait ~ Treatment * Geno_ID, data = data, contrasts = list(Treatment=contr.sum, Geno_ID = contr.sum)), c("Treatment", "Geno_ID"), type = "reponse")
  return(tab2)
}

get_geno_table_bt22 <- function(trait, data = Dat_2022){
  mod <- lm(trait ~ Treatment * Geno_ID, data = data, contrasts = list(Treatment=contr.sum, Geno_ID = contr.sum))
  tab2 <- emmeans(update(ref_grid(mod), tran = "log10"), c("Treatment", "Geno_ID"), type = "response") #
  return(tab2)
}
...
geno_sla_22 <- as.data.frame(get_geno_table_bt22(Dat_2022$l10_SLA))
...
geno_rwc_22 <- as.data.frame(get_geno_table22(Dat_2022$RWC))
...
geno_ag_22 <- as.data.frame(get_geno_table_bt22(Dat_2022$l10_AG_DryBiomass))
...
geno_bg_22 <- as.data.frame(get_geno_table22(Dat_2022$BG_DryBiomass))
...
geno_rs_22 <- as.data.frame(get_geno_table_bt22(Dat_2022$l10_Root_to_Shoot))
...
``` r
# total biomass
TotBio_lm_22 <- do_lmer2(Dat_2022$TotalBiomass) # residuals pretty normal, don't worry about sqrt transformation
```
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.3747 -0.4832 -0.0659  0.4307  4.8878 
## 
## Random effects:
##  Groups          Name        Variance Std.Dev.
##  Population:Line (Intercept) 0.00846  0.09198 
##  Residual                    0.01287  0.11343 
## Number of obs: 127, groups:  Population:Line, 16
## 
## Fixed effects:
##                             Estimate Std. Error         df t value Pr(>|t|)    
## (Intercept)                3.928e-01  2.558e-02  1.419e+01  15.354 3.10e-10 ***
## Treatment1                 2.966e-02  1.011e-02  1.086e+02   2.933   0.0041 ** 
## Population1               -1.447e-01  2.558e-02  1.418e+01  -5.658 5.63e-05 ***
## Treatment1:Population1     1.204e-02  1.011e-02  1.086e+02   1.190   0.2366    
## TreatmentCurrent:Chamber1 -1.054e-02  1.424e-02  1.083e+02  -0.740   0.4607    
## TreatmentFuture:Chamber1   3.162e-04  1.438e-02  1.090e+02   0.022   0.9825    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Correlation of Fixed Effects:
...
```
##                                  2.5 %      97.5 %
## .sig01                     0.055927592  0.13365050
## .sigma                     0.098213365  0.12769773
## (Intercept)                0.342578993  0.44226781
## Treatment1                 0.010093113  0.04933860
## Population1               -0.194936713 -0.09526232
## Treatment1:Population1    -0.007527932  0.03172252
## TreatmentCurrent:Chamber1 -0.038143179  0.01710903
## TreatmentFuture:Chamber1  -0.027702075  0.02811936
```
...
## Type III Analysis of Variance Table with Satterthwaite's method
##                       Sum Sq Mean Sq NumDF   DenDF F value    Pr(>F)    
## Treatment            0.03715 0.03715     1 108.980  2.8875   0.09212 .  
## Population           0.41180 0.41180     1  14.183 32.0075 5.629e-05 ***
## Treatment:Population 0.01823 0.01823     1 108.626  1.4166   0.23656    
## Treatment:Chamber    0.00706 0.00353     2 108.660  0.2743   0.76062    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
geno_TotBio_22 <- as.data.frame(get_geno_table22(Dat_2022$TotalBiomass))
...
![](02_Analysis_files/figure-html/unnamed-chunk-57-5.png)<!-- -->![](02_Analysis_files/figure-html/unnamed-chunk-57-6.png)<!-- -->![](02_Analysis_files/figure-html/unnamed-chunk-57-7.png)<!-- -->
...
![](02_Analysis_files/figure-html/unnamed-chunk-57-8.png)<!-- -->
...
``` r
geno_stoden_22 <- as.data.frame(get_geno_table_bt22(Dat_2022$l10_Stomata_density))
...
``` r
AnovaResults_2022 <- rbind(emergence_anov_22, bolting_anov_22, fresh_anov_22, hyd_anov_22, dry_anov_22, area_anov_22, per_anov_22, sla_anov_22, ldmc_anov_22, rwc_anov_22, LN_PreVern_anov_22, LN_Jun6_anov_22, LN_Jun13_anov_22, LN_bolt_anov_22, AG_anov_22, BG_anov_22, RS_anov_22, TotBio_anov_22, sto_den_anov_22 )
...
``` r
# change column names
dfs3 <- c("bolting_means_22", "dry_means_22", "area_means_22", "per_means_22", "rwc_means_22", "LN_PreVern_means_22", "LN_Jun6_means_22", "LN_Jun13_means_22", "BG_means_22", "emergence_means_22", "fresh_means_22", "hyd_means_22", "sla_means_22", "ldmc_means_22", "LN_bolt_means_22", "AG_means_22", "RS_means_22", "TotBio_means_22", "sto_den_means_22")
...
# create list of data frames
Means_2022 <- list(emergence_means_22, bolting_means_22, fresh_means_22, hyd_means_22, dry_means_22, area_means_22, per_means_22, sla_means_22, ldmc_means_22, rwc_means_22, LN_PreVern_means_22, LN_Jun6_means_22, LN_Jun13_means_22, LN_bolt_means_22, AG_means_22, BG_means_22, RS_means_22, TotBio_means_22, sto_den_means_22)

# name that list
names(Means_2022) <- c("emergence_means_22", "bolting_means_22", "fresh_means_22", "hyd_means_22", "dry_means_22", "area_means_22", "per_means_22", "sla_means_22", "ldmc_means_22", "rwc_means_22", "LN_PreVern_means_22", "LN_Jun6_means_22", "LN_Jun13_means_22", "LN_bolt_means_22", "AG_means_22", "BG_means_22", "RS_means_22", "TotBio_means_22", "sto_den_means_22")
...
``` r
PostHoc_2022 <- rbind(bolting_pairs_22, fresh_pairs_22, hyd_pairs_22, dry_pairs_22, area_pairs_22, per_pairs_22, sla_pairs_22, ldmc_pairs_22, rwc_pairs_22, LN_bolt_pairs_22, AG_pairs_22, BG_pairs_22, RS_pairs_22, TotBio_pairs_22, sto_den_pairs_22 )
...
![](02_Analysis_files/figure-html/unnamed-chunk-66-1.png)<!-- -->
...
![](02_Analysis_files/figure-html/unnamed-chunk-66-2.png)<!-- -->
...
![](02_Analysis_files/figure-html/unnamed-chunk-66-3.png)<!-- -->
...
![](02_Analysis_files/figure-html/unnamed-chunk-67-1.png)<!-- -->

``` r
hist(Dat_2021_TwoTrt$l10_AvgSeedNum)
```

![](02_Analysis_files/figure-html/unnamed-chunk-67-2.png)<!-- -->
